...
const useCodeExecution = () => {
    ...
    const submitCode = useCallback(async (problemId, code, language, courseId = null) => {
        setSubmitting(true);
        ...
        try {
            const response = await submissionService.submitCode(problemId, code, language, courseId);
            ...
            if (response.success) {
                const normalized = {
                    ...
                    totalAlphaCoins: response.totalAlphaCoins || 0,
