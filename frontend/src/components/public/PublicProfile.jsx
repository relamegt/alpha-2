        ...
        <div className="overflow-x-auto">
            {(!submissions || submissions.length === 0) ? (
                ...
                <table className="w-full text-left table-fixed">
                    <thead className="text-[10px] text-gray-400 font-bold uppercase tracking-wider bg-[#F1F3F4] dark:bg-gray-800/50 border-b border-gray-100 dark:border-gray-700">
                        <tr>
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {submissions.slice(0, 5).map((submission, idx) => {
                            ...
                            return (
                                <tr key={idx} className="hover:bg-gray-50/20 dark:hover:bg-gray-800/20 transition-colors border-b border-gray-100/50 dark:border-gray-800 last:border-0">
                                    ...
                                    <td className="px-6 py-4 text-center">
                                        {isCodingProblem ? (
                                            <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-bold border ${isAccepted ? 'bg-green-50 text-green-700 border-green-200' : 'bg-red-50 text-red-700 border-red-200'}`}>
