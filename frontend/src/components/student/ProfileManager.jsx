...
const ProfileManager = () => {
    ...
    if (initialLoading) {
        return (
            <div className="p-6 bg-[#F7F5FF] dark:bg-[#111117] min-h-screen transition-colors">
                ...
                {/* Tabs Skeleton */}
                <div className="flex space-x-4 border-b border-gray-100 dark:border-gray-800 mb-6 pb-2 animate-pulse">
    ...
    return (
        <div className="p-6 bg-[#F7F5FF] dark:bg-[#111117] min-h-screen transition-colors">
            ...
            {/* Tabs */}
            <div className="flex space-x-4 border-b border-gray-100 dark:border-gray-800 mb-6 overflow-x-auto">
                <button
