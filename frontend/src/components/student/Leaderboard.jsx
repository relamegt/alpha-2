...
const Leaderboard = ({ batchId, isBatchView }) => {
    ...
    return (
        <div className="min-h-screen bg-[var(--color-bg-primary)] pb-12 transition-colors">

            {/* Fixed Dropdown Portal –" renders outside sticky header stacking context */}
            {isBatchView && showOptions && (
                <div
                    ref={optionsRef}
                    className="fixed w-64 bg-white/95 dark:bg-[var(--color-bg-card)]/95 backdrop-blur-xl rounded-2xl border border-gray-100 dark:border-gray-700/50 overflow-hidden z-[9999]"
                    style={{
                        top: dropdownPos.top,
            ...
            {/* Header Section */}
            {isBatchView ? (
                <div className="bg-white/95 dark:bg-[var(--color-bg-card)]/95 backdrop-blur-md border-b border-gray-100 dark:border-gray-800 shadow-sm sticky top-0 z-30 transition-colors">
                    <div className="w-full mx-auto px-6 h-16 flex items-center justify-between relative">
                        ...
                        <div>
                            <button
                                ...
                                className={`p-1.5 rounded-full transition-colors focus:outline-none ${showOptions ? 'bg-gray-100 dark:bg-[var(--color-bg-card)] text-gray-700 dark:text-gray-200' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[var(--color-bg-card)]'}`}
                                title="Options"
                            >
                    ...
                    <div className="space-y-6">
                        {!isBatchView && (
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                ...
                                {/* Timeline Filters */}
                                {/* <div className="bg-white dark:bg-[#111117] p-1 rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm flex items-center transition-colors">
                                    <button
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4">
                            <div className="relative w-full sm:w-80 group">
                                ...
                                <input
                                    type="text"
                                    className="block w-full pl-10 pr-3 py-2.5 border border-gray-100 dark:border-gray-800 rounded-xl bg-white dark:bg-[#111117] text-gray-900 dark:text-gray-100 text-sm placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-purple-500/10 focus:border-purple-500 transition-all shadow-sm"
                                    ...
                                    <table className="min-w-full text-sm border-separate border-spacing-0">
                                        <thead className="bg-gray-50 dark:bg-[#111117] transition-colors sticky top-0 z-[100]">
                                            <tr className="border-b border-gray-100 dark:border-gray-800">
                                                <th
                                                    className="px-4 py-3 text-left text-xs font-bold text-gray-900 dark:text-white uppercase tracking-wider border-r border-gray-200 dark:border-gray-800 sticky left-0 bg-white dark:bg-[#111117] z-[120] w-[90px] min-w-[90px] cursor-pointer hover:bg-gray-50 dark:hover:bg-[#23232e]"
                                                ...
                                                <th
                                                    className="px-4 py-3 text-left text-xs font-bold text-gray-900 dark:text-white uppercase tracking-wider border-r border-gray-200 dark:border-gray-800 static md:sticky md:left-[90px] bg-white dark:bg-[#111117] z-[120] w-[130px] min-w-[130px] cursor-pointer hover:bg-gray-50 dark:hover:bg-[#23232e]"
                                                ...
                                                <th
                                                    className="px-4 py-3 text-left text-xs font-bold text-gray-900 dark:text-white uppercase tracking-wider border-r border-gray-200 dark:border-gray-800 static md:sticky md:left-[220px] bg-white dark:bg-[#111117] z-[120] w-[260px] min-w-[260px] cursor-pointer hover:bg-gray-50 dark:hover:bg-[#23232e]"
                                                ...
                                                <th
                                                    className="px-4 py-3 text-left text-xs font-bold text-gray-900 dark:text-white uppercase tracking-wider border-r border-gray-200 dark:border-gray-800 relative group transition-colors"
                                                    rowSpan={viewMode === 'detailed' ? 2 : 1}
                                                >
                                                    ...
                                                    {activeFilter === 'branch' && (
                                                        <div className="absolute top-full left-0 mt-1 w-40 bg-white dark:bg-[#111117] border border-gray-100 dark:border-gray-800 rounded-lg shadow-xl z-50 p-2 max-h-60 overflow-y-auto transition-colors">
                                                            <div className="space-y-0.5">
                                                                <button
                                                ...
                                                <th className="px-4 py-3 text-left text-xs font-bold text-gray-900 dark:text-white uppercase tracking-wider border-r border-gray-200 dark:border-gray-800 hidden lg:table-cell min-w-[120px]" rowSpan={viewMode === 'detailed' ? 2 : 1}>Username</th>
                                                <th
                                                    className="px-4 py-3 text-center text-xs font-bold text-gray-900 dark:text-white uppercase tracking-wider border-r border-gray-200 dark:border-gray-800 cursor-pointer hover:bg-gray-50 dark:hover:bg-[#23232e] min-w-[180px]"
                                                ...
                                                <th
                                                    className="px-4 py-3 text-center text-xs font-bold text-indigo-700 dark:text-indigo-300 uppercase tracking-wider border-l-2 border-gray-200 dark:border-indigo-900/50 bg-[#f8faff] dark:bg-[var(--color-bg-card)] sticky right-0 z-[120] cursor-pointer hover:bg-indigo-50 dark:hover:bg-indigo-900/40 min-w-[100px] transition-colors"
                                            ...
                                            {viewMode === 'detailed' && (
                                                <tr className="bg-gray-50/50 dark:bg-[#0c1118] text-[10px] text-gray-600 dark:text-gray-400 border-b border-gray-100 dark:border-gray-800">
                                                ...
                                                return (
                                                    <tr
                                                        ...
                                                        className={`group transition-colors ${isCurrentUser
                                                            ? ''
                                                            : 'bg-[var(--color-bg-card)] hover:bg-[var(--color-bg-hover)] transition-colors'
                                                            }`}
                                                    >
                                                        <td
                                                            style={currentUserBg}
                                                            className={`px-4 py-3 whitespace-nowrap font-bold sticky left-0 z-40 text-center border-b border-gray-100 dark:border-gray-700 border-r border-gray-200 dark:border-gray-800 w-[90px] min-w-[90px] ${isCurrentUser ? '' : 'bg-[var(--color-bg-card)] group-hover:bg-[var(--color-bg-hover)]'}`}
                                                        >
                                                        ...
                                                        <td
                                                            style={currentUserBg}
                                                            className={`px-4 py-3 whitespace-nowrap static md:sticky md:left-[90px] z-40 border-b border-gray-100 dark:border-gray-700 border-r border-gray-200 dark:border-gray-800 w-[130px] min-w-[130px] ${isCurrentUser ? '' : 'bg-[var(--color-bg-card)] group-hover:bg-[var(--color-bg-hover)]'}`}
                                                        >
                                                        ...
                                                        <td style={currentUserBg} className={`px-4 py-3 whitespace-nowrap text-sm text-gray-900 dark:text-gray-300 border-b border-gray-100 dark:border-gray-700 border-r border-gray-200 dark:border-gray-800 ${isCurrentUser ? '' : 'bg-[var(--color-bg-card)]'}`}>
                                                            {entry.branch}
                                                        </td>
                                                        <td style={currentUserBg} className={`px-4 py-3 whitespace-nowrap text-sm text-gray-900 dark:text-gray-300 border-b border-gray-100 dark:border-gray-700 border-r border-gray-200 dark:border-gray-800 hidden lg:table-cell ${isCurrentUser ? '' : 'bg-[var(--color-bg-card)]'}`}>
                                                        ...
                                                        <td style={currentUserBg} className={`px-4 py-3 whitespace-nowrap font-medium text-gray-600 dark:text-gray-400 border-r border-gray-200 dark:border-gray-800 border-b border-gray-100 dark:border-gray-700 text-center ${isCurrentUser ? '' : 'bg-[var(--color-bg-card)]'}`}>
                                                            {entry.alphaCoins || 0}
                                                        </td>
                                                        ...
                                                        {internalContestsMeta.map(contest => {
                                                            ...
                                                            return (
                                                                <td key={contest.id} style={currentUserBg} className={`px-3 py-2 whitespace-nowrap text-center text-gray-600 dark:text-gray-400 border-l border-gray-100 dark:border-gray-700 border-r border-gray-200 dark:border-gray-800 border-b border-gray-100 dark:border-gray-700 ${isCurrentUser ? '' : 'bg-white dark:bg-[var(--color-bg-card)]'}`}>
                                                                    {participated ? (
                                                        ...
                                                        <td
                                                            style={currentUserBg}
                                                            className={`px-2 py-1.5 whitespace-nowrap font-extrabold text-lg text-indigo-700 dark:text-indigo-300 border-l-2 border-gray-200 dark:border-indigo-900/40 sticky right-0 z-40 text-center border-b border-gray-100 dark:border-gray-700 ${isCurrentUser ? '' : 'bg-[#f8faff] dark:bg-[var(--color-bg-card)]'}`}
                                                        >
                                                            {entry.overallScore}
                                                        </td>
                                                    </tr>
                                        ...
                                        {externalLeaderboard.length === 0 ? (
                                            ...
                                            <div className="overflow-x-auto">
                                                <table className="min-w-full divide-y divide-gray-200">
                                                    <thead className="bg-gray-50 dark:bg-[var(--color-bg-card)] transition-colors border-b border-gray-100 dark:border-gray-800 sticky top-0 z-[100]">
                                                        <tr>
                                    ...
                                    <div>
                                        ...
                                        <div className="overflow-x-auto pb-4 custom-scrollbar">
                                            <table className="min-w-max w-full border-separate border-spacing-0">
                                                <thead className="bg-[#f8fafc] dark:bg-[var(--color-bg-card)] sticky top-0 z-10 shadow-sm transition-colors">
                                                    <tr>
                                                        <th className="px-3 py-4 text-left text-xs font-bold text-gray-900 dark:text-white uppercase cursor-pointer hover:bg-gray-100 dark:hover:bg-[#23232e] sticky left-0 bg-white dark:bg-[#111117] z-[120] shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)] dark:shadow-[2px_0_8px_-2px_rgba(0,0,0,0.5)] min-w-[60px] border-b border-gray-100 dark:border-gray-800 border-r border-gray-200 dark:border-gray-800" onClick={() => handleInternalSort('rank')}>
                                                            Rank {internalSortConfig.key === 'rank' && (internalSortConfig.direction === 'asc' ? '▲' : '▼')}
                                                        </th>
                                                        <th className="px-3 py-4 text-left text-xs font-bold text-gray-900 dark:text-white uppercase cursor-pointer hover:bg-gray-100 dark:hover:bg-[#23232e] static md:sticky md:left-[60px] bg-white dark:bg-[#111117] z-[120] border-b border-gray-100 dark:border-gray-800 border-r border-gray-200 dark:border-gray-800 min-w-[110px] md:shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)] dark:md:shadow-[2px_0_8px_-2px_rgba(0,0,0,0.5)]" onClick={() => handleInternalSort('rollNumber')}>
                                                            Roll No {internalSortConfig.key === 'rollNumber' && (internalSortConfig.direction === 'asc' ? '▲' : '▼')}
                                                        </th>
                                                        <th className="px-3 py-4 text-left text-xs font-bold text-gray-900 dark:text-white uppercase cursor-pointer hover:bg-gray-100 dark:hover:bg-[#23232e] static md:sticky md:left-[170px] bg-white dark:bg-[#111117] z-[120] dark:md:shadow-[4px_0_12px_-4px_rgba(0,0,0,0.7)] border-b border-gray-100 dark:border-gray-800 border-r border-gray-200 dark:border-gray-800 min-w-[140px]" onClick={() => handleInternalSort('username')}>
                                                            Username {internalSortConfig.key === 'username' && (internalSortConfig.direction === 'asc' ? '▲' : '▼')}
                                                        </th>
                                                        <th className="px-3 py-4 text-left text-xs font-bold text-gray-900 dark:text-white uppercase cursor-pointer hover:bg-gray-100 dark:hover:bg-[#23232e] min-w-[120px] border-b border-gray-100 dark:border-gray-800" onClick={() => handleInternalSort('fullName')}>
                                                            Full Name {internalSortConfig.key === 'fullName' && (internalSortConfig.direction === 'asc' ? '▲' : '▼')}
                                                        </th>
                                                        <th className="px-3 py-4 text-left text-xs font-bold text-gray-900 dark:text-white uppercase cursor-pointer hover:bg-gray-100 dark:hover:bg-[#23232e] border-b border-gray-100 dark:border-gray-800" onClick={() => handleInternalSort('branch')}>
                                                        ...
                                                        <th className="px-3 py-4 text-center text-xs font-bold text-gray-900 dark:text-white uppercase cursor-pointer hover:bg-gray-100 dark:hover:bg-[#23232e] whitespace-nowrap border-b border-gray-100 dark:border-gray-800 border-l border-[var(--color-border-interactive)]" onClick={() => handleInternalSort('time')}>Time</th>
                                                        <th className="px-3 py-4 text-center text-xs font-bold text-gray-900 dark:text-white uppercase cursor-pointer hover:bg-gray-100 dark:hover:bg-[#23232e] whitespace-nowrap border-b border-gray-100 dark:border-gray-800 border-l border-[var(--color-border-interactive)]" onClick={() => handleInternalSort('problemsSolved')}>Solved</th>
                                                        <th className="px-3 py-4 text-center text-xs font-bold text-gray-900 dark:text-white uppercase whitespace-nowrap border-b border-gray-100 dark:border-gray-800 border-l border-[var(--color-border-interactive)]">Tab Switches</th>
                                                        <th className="px-3 py-4 text-center text-xs font-bold text-gray-900 dark:text-white uppercase whitespace-nowrap border-b border-gray-100 dark:border-gray-800 border-l border-[var(--color-border-interactive)]">FS Exits</th>
                                                        <th className="px-3 py-4 text-center text-xs font-bold text-gray-900 dark:text-white uppercase whitespace-nowrap border-b border-gray-100 dark:border-gray-800 border-l border-[var(--color-border-interactive)]">Violations</th>
                                                        <th className="px-3 py-4 text-center text-xs font-bold text-gray-900 dark:text-white uppercase whitespace-nowrap border-b border-gray-100 dark:border-gray-800 border-l border-[var(--color-border-interactive)]">Status</th>
                                                        <th className="px-3 py-4 text-center text-xs font-bold text-gray-900 dark:text-white uppercase cursor-pointer hover:bg-gray-100 dark:hover:bg-[#23232e] whitespace-nowrap sticky right-0 bg-white dark:bg-[#111117] z-[120] dark:shadow-[-4px_0_12px_-4px_rgba(0,0,0,0.7)] min-w-[70px] border-b border-gray-100 dark:border-gray-800 border-l-2 border-[var(--color-border-interactive)]" onClick={() => handleInternalSort('score')}>
                                                            ...
                                                            <>
                                                                ...
                                                                {currentUserEntry && (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        {contestInfo?.problems?.map(prob => {
                                                                            ...
                                                                            let bgClass = 'bg-gray-50 dark:bg-[#111117]/40 border-[var(--color-border-interactive)]';
                                                                ...
                                                                {paginatedInternalData.map((entry, index) => {
                                                                    ...
                                                                    return (
                                                                        ...
                                                                        >
                                                                            <td className="px-3 py-4 whitespace-nowrap sticky left-0 z-40 border-b border-gray-100 dark:border-gray-800 border-r border-gray-200 dark:border-gray-800 transition-colors shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)] dark:shadow-[2px_0_8px_-2px_rgba(0,0,0,0.5)] w-[60px] min-w-[60px] bg-white dark:bg-[#111117] group-hover:bg-gray-50 dark:group-hover:bg-[#23232e]">
                                                                            ...
                                                                            {/* Roll No - sticky */}
                                                                            <td className="px-3 py-4 whitespace-nowrap text-sm font-mono static md:sticky md:left-[60px] z-40 border-b border-gray-100 dark:border-gray-800 border-r border-gray-200 dark:border-gray-800 transition-colors md:shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)] dark:md:shadow-[2px_0_8px_-2px_rgba(0,0,0,0.5)] w-[110px] min-w-[110px] bg-white dark:bg-[#111117] text-gray-700 dark:text-gray-300 group-hover:bg-gray-50 dark:group-hover:bg-[#23232e]">{entry.rollNumber}</td>
                                                                            {/* Username Column */}
                                                                            <td className="px-3 py-4 text-sm font-bold max-w-[140px] min-w-[140px] truncate static md:sticky md:left-[170px] z-40 border-b border-gray-100 dark:border-gray-800 border-r border-gray-200 dark:border-gray-800 dark:md:shadow-[4px_0_12px_-4px_rgba(0,0,0,0.7)] transition-colors bg-white dark:bg-[#111117] group-hover:bg-gray-50 dark:group-hover:bg-[#23232e] text-gray-900 dark:text-gray-100" title={(entry.isSpotUser || entry.username?.startsWith('spot_')) ? '' : (entry.username !== 'N/A' && entry.username ? entry.username : entry.fullName)}>
                                                                            ...
                                                                            {/* Full Name */}
                                                                            <td className="px-3 py-3 text-sm max-w-[120px] truncate border-b border-gray-100 dark:border-gray-800 text-gray-500" title={entry.fullName}>{entry.fullName}</td>
                                                                            {/* Branch */}
                                                                            <td className="px-3 py-3 whitespace-nowrap text-sm border-b border-gray-100 dark:border-gray-800 text-gray-500">{entry.branch}</td>
                                                                            ...
                                                                            <td className="px-3 py-2 whitespace-nowrap text-sm text-center text-gray-600 dark:text-gray-400 font-mono border-b border-gray-100 dark:border-gray-800 border-l border-[var(--color-border-interactive)]">
                                                                                {(() => {
                                                                            ...
                                                                            <td className="px-3 py-2 whitespace-nowrap text-center border-b border-gray-100 dark:border-gray-800 border-l border-[var(--color-border-interactive)]">
                                                                            ...
                                                                            <td className="px-3 py-2 whitespace-nowrap text-sm text-center border-b border-gray-100 dark:border-gray-800 border-l border-[var(--color-border-interactive)]">
                                                                            ...
                                                                            <td className="px-3 py-4 whitespace-nowrap text-center sticky right-0 z-[120] border-l-2 border-[var(--color-border-interactive)] border-b border-gray-100 dark:border-gray-800 dark:shadow-[-4px_0_12px_-4px_rgba(0,0,0,0.6)] transition-colors bg-white dark:bg-[#111117] group-hover:bg-gray-50 dark:group-hover:bg-[#23232e]">
