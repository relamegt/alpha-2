...
const CodingProfiles = () => {
    ...
    if (initialLoading) {
        return (
            <div className="w-full space-y-8 animate-pulse">
                ...
                <div className="bg-[var(--color-bg-card)] rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden transition-colors">
    ...
    return (
        <div className="w-full space-y-12 animate-fade-in transition-colors">
            ...
            <div>
                <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-6 pb-2 border-b border-gray-100 dark:border-gray-800 flex items-center gap-2">
                    <svg className="w-5 h-5 text-gray-600 dark:text-[var(--color-text-muted)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            ...
                            <div className="flex-grow space-y-2">
                                <div className="flex justify-between items-center mb-1">
                                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center gap-2">
                                        <span className="text-[var(--color-text-muted)] dark:text-[var(--color-text-muted)]">{platform.icon}</span>
                                        {platform.label}
                                    </label>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 bg-[var(--color-bg-input)] border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all shadow-sm"
