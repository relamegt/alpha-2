    ...
    if (error && !contest) {
        return (
            <div className="flex flex-col justify-center items-center h-screen bg-[#F7F5FF] dark:bg-[#111117] transition-colors p-4">
                <div className="bg-[#F1F3F4] dark:bg-[#111117] p-8 rounded-xl shadow-lg max-w-md w-full text-center border border-gray-100 dark:border-gray-800">
                        ...
                        <div className="text-center p-6 bg-amber-50 text-amber-800 rounded-xl border border-amber-200 mb-8">
                            ...
                            <div className="flex items-start justify-center w-full gap-3">
                                ...
                                <div className="timer w-14">
                                    <div className="bg-[#F1F3F4] dark:bg-gray-800 border border-amber-200 dark:border-amber-900/50 rounded-lg px-2 py-2 shadow-sm dark:shadow-none">
