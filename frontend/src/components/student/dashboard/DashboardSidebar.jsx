        ...
        >
            ...
            <div className="p-4 border-t border-[var(--color-border-interactive)] space-y-4">
                ...
                <div className="relative" ref={profileRef}>
                    ...
                    {isProfileOpen && (
                        <div
                            className={`absolute bottom-full left-0 mb-2 w-64 bg-white/95 dark:bg-[var(--color-bg-sidebar)] backdrop-blur-xl border border-gray-100 dark:border-gray-800 rounded-2xl shadow-2xl overflow-hidden transition-all duration-200 z-50 origin-bottom-left`}
                        >
                            {/* User Header */}
