            ...
            <div className="min-h-screen flex bg-[#F7F5FF] dark:bg-[#111117] font-sans">
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-16 relative">
                    <div className="max-w-md w-full space-y-8">
                        <div className="bg-[#F1F3F4] dark:bg-[#111117] p-8 sm:p-10 rounded-3xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-none border border-gray-100 dark:border-gray-800 transition-all duration-300 text-center">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-16 relative">
                <div className="max-w-md w-full space-y-8">
                    ...
                    <div className="text-center lg:hidden">
                        <div className="inline-flex justify-center mb-6 p-4 bg-[#F1F3F4] dark:bg-[#111117] rounded-full shadow-md border border-gray-100 dark:border-gray-800">
                    ...
                    <div className="bg-[#F1F3F4] dark:bg-[#111117] p-8 rounded-3xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-none border border-gray-100 dark:border-gray-800 transition-all duration-300">
