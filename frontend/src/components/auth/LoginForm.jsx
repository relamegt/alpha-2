            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-16 relative">
                <div className="max-w-md w-full space-y-8">
                    ...
                    <div className="text-center lg:hidden">
                        <div className="inline-flex justify-center mb-6 p-4 bg-[#F1F3F4] dark:bg-[var(--color-bg-card)] rounded-full shadow-md dark:shadow-none border border-gray-100 dark:border-gray-800">
                            <img
                                src="/alphalogo.png"
                                alt="AlphaKnowledge"
