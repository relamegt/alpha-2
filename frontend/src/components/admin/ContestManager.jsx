                ...
                <div className="animate-fade-in-up">
                    {view === 'create' ? (
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4 bg-[#F1F3F4] dark:bg-[#181820] p-4 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm dark:shadow-none transition-colors">
                            ...
                            {loading ? (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {filteredContests.map(contest => {
                                        ...
                                        return (
                                            <div key={contest._id} className={`group relative bg-[#F1F3F4] dark:bg-[#181820] rounded-2xl border transition-all duration-300 overflow-hidden flex flex-col h-full hover:-translate-y-1 hover:scale-[1.01] ${isActive
