...
const submissionService = {
    ...
    submitCode: async (problemId, code, language, courseId = null) => {
        try {
    ...
    markProblemComplete: async (problemId, answers = null, courseId = null) => {
        try {
            const response = await apiClient.post(`/student/code/${problemId}/complete`, { answers, courseId });
            return response.data;
        } catch (error) {
    ...
    getLatestSubmission: async (problemId) => {
        try {
            const response = await apiClient.get(`/student/submission/${problemId}/latest`);
            return response.data;
        } catch (error) {
            throw error.response?.data || { message: 'Failed to fetch latest submission' };
        }
    },
};
